# Portfolio Académique : Statistique & Analyse de Données
...
*   **Objectif** : Reproduction et évaluation critique d'une étude publiée dans *Nature Medicine* concernant l'impact de l'intelligence artificielle dans le dépistage national du cancer du sein en Allemagne.
*   **Compétences** : Régression logistique (modèles bruts et ajustés), analyse de performance diagnostique (taux de détection, taux de rappel, PPV), évaluation critique de méthodologie scientifique.
*   **Outils** : R (tidyverse, broom, ggplot2).

### 2. [Analyse des Séries Temporelles Appliquée au Marché du Travail Canadien](./Analyse-Series-Temporelles-Canada/)
*   **Objectif** : Étude de l'évolution des taux d'emploi et de chômage au Canada sur la période 2020-2024.
